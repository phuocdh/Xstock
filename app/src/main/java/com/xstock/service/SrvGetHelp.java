...
public class SrvGetHelp {

    public static String GetHelp(String token, String id) {

        String strGetHelp = "";

        // Soap config
        final String SOAP_ACTION = AppConfig.SOAP_NAMESPACE + AppConfig.GET_HELP;
        final String METHOD_NAME = AppConfig.GET_HELP;
        ...
        try {
            ...
            strGetHelp = jsonArray.getJSONObject(0).getString("Content").toString();
