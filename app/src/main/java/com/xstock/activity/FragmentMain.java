    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btn_item_stock_chart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentStockChart(), getResources().getString(R.string.item_stock_chart), View.INVISIBLE);
            }
        });
        ...
        btn_item_index_info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentIndexInfo(), getResources().getString(R.string.item_index_info), View.INVISIBLE);
            }
        });
        ...
        btn_item_news.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentNews(), getResources().getString(R.string.item_news), View.INVISIBLE);
            }
        });
        ...
        btn_item_price_table.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentPriceTable(), getResources().getString(R.string.item_price_table), View.INVISIBLE);
            }
        });
        ...
        btn_item_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentMessage(), getResources().getString(R.string.item_messages), View.INVISIBLE);
            }
        });
        ...
        btn_item_favorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentListCode(), getResources().getString(R.string.item_messages), View.INVISIBLE);
            }
        });
        ...
        btn_item_web.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentWeb(), getResources().getString(R.string.item_web), View.INVISIBLE);
            }
        });
        ...
        btn_item_guide.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentGuide(), getResources().getString(R.string.item_guide), View.INVISIBLE);
            }
        });
        ...
        btn_item_settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentSettings(), getResources().getString(R.string.item_settings), View.INVISIBLE);
            }
        });
        ...
        btn_item_contact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityCommunicator.passDataToActivity(new FragmentContact(), getResources().getString(R.string.item_contact), View.INVISIBLE);
            }
        });
