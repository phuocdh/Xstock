...
public class FragmentMessage extends Fragment {
    ...
    static ActionMode amActionMode = null;
    ArrayList<Integer> alstListSelectItem = new ArrayList<Integer>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        avLoading = (AVLoadingIndicatorView) v.findViewById(R.id.avMessageList);
...
//            Toast.makeText(getContext(),searchAdapter.getItem(position).getName(), Toast.LENGTH_SHORT).show();
        ...
        public void onDismiss(ListView listView, int[] reverseSortedPositions) {
            ...
            for (int i : reverseSortedPositions) {
                new ThreadAddDeleteUserTradeList(msgAdapter.getItem(i).getId(), "", 1, i).run();
    ...
    private class AsyncGetDetailMessager extends
        ...
        protected ArrayList<GetDetailMessage> doInBackground(String... params) {
            lstGetDetailMessage = new ArrayList<GetDetailMessage>();
            SessionManager session = new SessionManager(context);
    ...
    public class ThreadAddDeleteUserTradeList extends Thread {
        ...
        public ThreadAddDeleteUserTradeList(String id, String tradeName, int modify, int postiton) {
            this.id = id;
