...
public class RippleView extends Button {
    ...
    public RippleView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.RippleViewNew);
        mRippleColor = a.getColor(R.styleable.RippleViewNew_mrippleColor,
                mRippleColor);
        mAlphaFactor = a.getFloat(R.styleable.RippleViewNew_alphaFactor,
                mAlphaFactor);
        mHover = a.getBoolean(R.styleable.RippleViewNew_hover, mHover);
        a.recycle();
    }
