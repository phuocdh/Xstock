...
public class BadgeView extends TextView {
	...
	public void toggle(Animation animIn, Animation animOut,int a) {
		toggle(true, animIn, animOut,0);
	}
	...
	private void toggle(boolean animate, Animation animIn, Animation animOut,int a) {
			show(animate && (animIn != null), animIn);
	}
