package com.xstock.swipelistview;
...
public class ListViewSwipeGesture implements View.OnTouchListener {
    ...
    String RangeOneColor = "#E4224D";   //"#FFD060"
    ...
    private void GetResourcesValues() {
        ...
        if (isType == Single) {
            HalfDrawable = activity.getResources().getDrawable(R.drawable.rating_favorite);
        } else {
            HalfDrawable = activity.getResources().getDrawable(R.drawable.ic_delete_32);
        }
    ...
    private void SetBackGroundforList() {
        ...
        if (SwipeType == Double) {
            mDownView_parent_txt2 = new TextView(activity);
